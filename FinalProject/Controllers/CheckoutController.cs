            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if (lookup.Result.Any())
                    {
                        ...
                        {
                            if (_context.CartItems.Any(x => x.Product.Name == "Games Membership"))
                            {
                                _context.UserRoles.Add(
                                new IdentityUserRole<string>
                                {
                                    RoleId = _context.Roles.Single(x => x.Name == "Games Member").Id,
                                    UserId = _context.Users.Single(x => x.UserName == User.Identity.Name).Id
                                });
                                _context.SaveChanges();
                            }
                            else if (_context.CartItems.Any(x => x.Product.Name == "Manga Membership"))
                            {
                                _context.UserRoles.Add(
                                new IdentityUserRole<string>
                                {
                                    RoleId = _context.Roles.Single(x => x.Name == "Manga Member").Id,
                                    UserId = _context.Users.Single(x => x.UserName == User.Identity.Name).Id
                                });
                                _context.SaveChanges();
                            }
                            else if (_context.CartItems.Any(x => x.Product.Name == "Prime Membership"))
                            {
                                _context.UserRoles.Add(
                                new IdentityUserRole<string>
                                {
                                    RoleId = _context.Roles.Single(x => x.Name == "Prime Member").Id,
                                    UserId = _context.Users.Single(x => x.UserName == User.Identity.Name).Id
                                });
                                _context.SaveChanges();
                            }
                    ...
                    {
                        ModelState.AddModelError("ShippingStreet", "Unable to validate this address.  Please make sure you've entered it correctly");
                    }
